...
<?php
	...
	include 'Connect.php';
	$query="INSERT INTO film (fid,name,duration,oscar,rdate,estbudget,m_or_s,seasons,channel,ended) VALUES (NULL,'{$_POST["name"]}','{$_POST["duration"]}','{$_POST["oscars"]}','{$_POST["rdate"]}','{$_POST["estbudget"]}',0,NULL,NULL,NULL);";
...
<div class="headers">Select The Places Of Your Movie</div>  
